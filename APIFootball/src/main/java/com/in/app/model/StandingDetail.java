...
@AllArgsConstructor
@ToString
public class StandingDetail implements Serializable{
	...
	public String getFk_stage_key() {
		return fk_stage_key;
	}
	public void setFk_stage_key(String fk_stage_key) {
		this.fk_stage_key = fk_stage_key;
	}
